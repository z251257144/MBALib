...
@interface NSObject (ObservationHelper)
 ...
 */
- (void)addObserverForKeyPath:(NSString *)keyPath identifier:(NSString *)token options:(NSKeyValueObservingOptions)options task:(void (^)(id obj, NSDictionary *change))task;
...
/** Adds an observer to an object conforming to NSKeyValueObserving.
 ...
 @see addObserverForKeyPath:task:
 */
- (void)addObserverForKeyPaths:(NSArray *)keyPaths identifier:(NSString *)token options:(NSKeyValueObservingOptions)options task:(void (^)(id obj, NSString *keyPath, NSDictionary *change))task;
